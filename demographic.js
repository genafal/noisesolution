...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const orders = {
        ...
        "location": ["Lincoln", "Salisbury", "Bournemouth", "St. Albans", "Bath", "Cambridge", "Chelmsford", "Colchester", "Ipswich", "Milton Keynes", "London", "Norwich", "Peterborough", "Romford", "Stevenage"],
